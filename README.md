...
|-----------|-----------|-------------|
| <img src="v-photos/XIAOESP32-C6.jpg" width="200" height="200"> | **XIAO ESP32-C6** | • Main microcontroller of the robot <br> • Processes RPLiDAR distance data <br> • Controls steering servo and motor driver <br> • Communicates with ESP32-CAM via UART <br> • Runs navigation and PID control logic |
